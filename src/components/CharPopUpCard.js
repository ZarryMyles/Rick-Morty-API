        ...
        <div className=" flex flex-col z-50 items-center text-center">
          ...
          <div className="flex justify-between my-5 md:px-0 px-3 md:w-4/5 flex-row">
            <div className="w-full md:mx-0 mx-2">
              <div className="font-bold md:font-semibold text-xl md:mb-5 mb-12">Origin</div>
              <div>
                {' '}
                <div className="mb-2 ">
                ...
                <div className="mb-5">
                  <span className="font-bold md:font-semibold">No. of Residents</span>:{' '}
            ...
            <div className="w-full flex flex-col md:mx-0 mx-2">
              <div className="font-bold md:font-semibold text-xl mb-5">Current Location</div>
              <div className="mb-2">
                <span className="font-bold md:font-semibold">Place</span>:{' '}
